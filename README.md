...
```
gnupod-init         init a new iPod (create empty Database + Directories)
gnupod-addsong      Add files
gnupod-check        Check for 'zombie' files
gnupod-otgsync      Handles On-The-Go Sync (not for humans)
gnupod-search       Search ;)
